h1. Lazy Load Plugin for jQuery | Zepto
...
* IE6/7 supported;
* Available with "https://github.com/madrobby/zepto":Zepto
...
Lazy Load depends on jQuery or Zepto. Include them both in end of your HTML code:
...
<pre><script src="//webmap2.map.bdimg.com/yyfm/jQuery_1.x/1.10.2/js/jQuery_1.x.min.js"></script>
<!-- or <script src="//webmap2.map.bdimg.com/yyfm/zepto/1.0/js/zepto.min.js"></script> -->
<script src="//webmap3.map.bdimg.com/yyfm/lazyLoad/1.0.0/js/lazyLoad.min.js"></script></pre>
